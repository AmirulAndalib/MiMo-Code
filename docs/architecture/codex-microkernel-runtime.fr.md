...
- les cas du profil GPT concernant `exec`, la description Bash, `skill_search` et `multiedit` sont actuellement ignorés dans [`registry-toolset.test.ts`](../../packages/opencode/test/tool/registry-toolset.test.ts#L17).
