...
export const dict = {
  ...
  "tui.command.visual_mode.title_on": "Vivid 模式：已开启 — 点击使用极简视觉",
  "tui.command.visual_mode.title_off": "Vivid 模式：已关闭 — 点击使用丰富视觉",
  "tui.command.visual_mode.description_on": "显示星空、流星、Logo 特效和动态进行中标记",
  "tui.command.visual_mode.description_off": "使用极简视觉和稳定的进行中标记",
  "tui.visual_mode.enabled": "Vivid 模式已开启",
  "tui.visual_mode.disabled": "Vivid 模式已关闭 — 正在使用极简视觉",
