...
export const dict = {
  ...
  "tui.command.visual_mode.title_on": "Mode Vivid : activé — cliquer pour des visuels minimalistes",
  "tui.command.visual_mode.title_off": "Mode Vivid : désactivé — cliquer pour des visuels riches",
  "tui.command.visual_mode.description_on": "Étoiles, météores, effets du logo et indicateurs animés",
  "tui.command.visual_mode.description_off": "Visuels minimalistes avec indicateurs d’activité stables",
  "tui.visual_mode.enabled": "Mode Vivid activé",
  "tui.visual_mode.disabled": "Mode Vivid désactivé — visuels minimalistes utilisés",
