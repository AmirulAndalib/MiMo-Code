...
export const dict = {
  ...
  "tui.command.visual_mode.title_on": "Vivid 模式：已開啟 — 點擊使用極簡視覺",
  "tui.command.visual_mode.title_off": "Vivid 模式：已關閉 — 點擊使用豐富視覺",
  "tui.command.visual_mode.description_on": "顯示星空、流星、Logo 特效和動態進行中標記",
  "tui.command.visual_mode.description_off": "使用極簡視覺和穩定的進行中標記",
  "tui.visual_mode.enabled": "Vivid 模式已開啟",
  "tui.visual_mode.disabled": "Vivid 模式已關閉 — 正在使用極簡視覺",
