...
export const dict = {
  ...
  "tui.command.visual_mode.title_on": "Режим Vivid: включён — нажмите для минимального оформления",
  "tui.command.visual_mode.title_off": "Режим Vivid: выключен — нажмите для яркого оформления",
  "tui.command.visual_mode.description_on": "Звёзды, метеоры, эффекты логотипа и анимированные индикаторы",
  "tui.command.visual_mode.description_off": "Минимальное оформление со стабильными индикаторами",
  "tui.visual_mode.enabled": "Режим Vivid включён",
  "tui.visual_mode.disabled": "Режим Vivid выключен — используется минимальное оформление",
