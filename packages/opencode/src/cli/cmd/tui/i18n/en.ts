export const dict: Record<string, string> = {
  ...
  "tui.command.visual_mode.title_on": "Vivid mode: ON — click to use minimal visuals",
  "tui.command.visual_mode.title_off": "Vivid mode: OFF — click to use vivid visuals",
  "tui.command.visual_mode.description_on": "Stars, meteors, logo effects, and animated activity indicators",
  "tui.command.visual_mode.description_off": "Minimal visuals with stable activity indicators",
  "tui.visual_mode.enabled": "Vivid mode enabled",
  "tui.visual_mode.disabled": "Vivid mode disabled — using minimal visuals",
