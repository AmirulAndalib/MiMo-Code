...
export const dict = {
  ...
  "tui.command.visual_mode.title_on": "Modo Vivid: activado — clic para usar visuales mínimos",
  "tui.command.visual_mode.title_off": "Modo Vivid: desactivado — clic para usar visuales intensos",
  "tui.command.visual_mode.description_on": "Estrellas, meteoros, efectos del logo e indicadores animados",
  "tui.command.visual_mode.description_off": "Visuales mínimos con indicadores de actividad estables",
  "tui.visual_mode.enabled": "Modo Vivid activado",
  "tui.visual_mode.disabled": "Modo Vivid desactivado — usando visuales mínimos",
