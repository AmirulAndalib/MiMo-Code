...
export const dict = {
  ...
  "tui.command.visual_mode.title_on": "Vividモード：オン — クリックしてミニマル表示へ",
  "tui.command.visual_mode.title_off": "Vividモード：オフ — クリックしてリッチ表示へ",
  "tui.command.visual_mode.description_on": "星空、流星、ロゴ効果、動く進行状況を表示",
  "tui.command.visual_mode.description_off": "安定した進行表示を使うミニマルな外観",
  "tui.visual_mode.enabled": "Vividモードを有効にしました",
  "tui.visual_mode.disabled": "Vividモードを無効にしました — ミニマル表示を使用中",
